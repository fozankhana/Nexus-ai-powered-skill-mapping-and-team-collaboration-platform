  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-muted/40 px-4">
      <div className="w-full max-w-md space-y-6">
        ...
        {/* Demo credentials */}
        <div className="rounded-lg border border-dashed px-4 py-3 text-center text-xs text-muted-foreground">
          <span className="font-semibold">Demo account:</span>{" "}
          <button
            type="button"
            className="font-mono hover:text-foreground transition-colors"
            onClick={() => setForm({ email: "admin@gmail.com", password: "admin" })}
          >
            admin@gmail.com
          </button>{" "}
          / password:{" "}
          <span className="font-mono">admin</span>
          <span className="ml-1 text-muted-foreground/60">(click email to fill)</span>
        </div>
